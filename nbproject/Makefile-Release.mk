...
${OBJECTDIR}/Arvore/arvore.o: Arvore/arvore.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/arvore.o Arvore/arvore.c

${OBJECTDIR}/Arvore/arvore2.o: Arvore/arvore2.c 
	${MKDIR} -p ${OBJECTDIR}/Arvore
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/arvore2.o Arvore/arvore2.c

${OBJECTDIR}/Arvore/arvoreB.o: Arvore/arvoreB.c 
	${MKDIR} -p ${OBJECTDIR}/Arvore
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/arvoreB.o Arvore/arvoreB.c

${OBJECTDIR}/Arvore/arvvar.o: Arvore/arvvar.c 
	${MKDIR} -p ${OBJECTDIR}/Arvore
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/arvvar.o Arvore/arvvar.c

${OBJECTDIR}/Arvore/main.o: Arvore/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arvore
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/main.o Arvore/main.cpp

${OBJECTDIR}/Arvore/util.o: Arvore/util.c 
	${MKDIR} -p ${OBJECTDIR}/Arvore
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/util.o Arvore/util.c
...
${OBJECTDIR}/Arvore/arvore_nomain.o: ${OBJECTDIR}/Arvore/arvore.o Arvore/arvore.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/arvore_nomain.o Arvore/arvore.c;\
	else  \
...
${OBJECTDIR}/Arvore/arvore2_nomain.o: ${OBJECTDIR}/Arvore/arvore2.o Arvore/arvore2.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/arvore2_nomain.o Arvore/arvore2.c;\
	else  \
...
${OBJECTDIR}/Arvore/arvoreB_nomain.o: ${OBJECTDIR}/Arvore/arvoreB.o Arvore/arvoreB.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/arvoreB_nomain.o Arvore/arvoreB.c;\
	else  \
...
${OBJECTDIR}/Arvore/arvvar_nomain.o: ${OBJECTDIR}/Arvore/arvvar.o Arvore/arvvar.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/arvvar_nomain.o Arvore/arvvar.c;\
	else  \
...
${OBJECTDIR}/Arvore/main_nomain.o: ${OBJECTDIR}/Arvore/main.o Arvore/main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/main_nomain.o Arvore/main.cpp;\
	else  \
...
${OBJECTDIR}/Arvore/util_nomain.o: ${OBJECTDIR}/Arvore/util.o Arvore/util.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arvore/util_nomain.o Arvore/util.c;\
	else  \
